...
use ClientApi\Pdm\Model\ModelInterface;
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\ClientApi\Pdm\Model\\' . $data->{$discriminator};
            ...
            // PVE indexed-family hook: bucket net0..netN-style wire keys
            // hidden from $openAPITypes into $container.
            if (method_exists($instance, '_loadIndexedFamilies')) {
                $instance->_loadIndexedFamilies($data);
            }
