...
/**
 * NodesStatusGetStatusResponseDataCurrentKernel Class Doc Comment
 *
 * @category Class
 ...
 */
class NodesStatusGetStatusResponseDataCurrentKernel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NodesStatusGetStatusResponse_data_current_kernel';
     ...
     * Sets machine
     *
     * @param string $machine The machine architecture
     *
     * @return self
     */
     ...
     * Sets release
     *
     * @param string $release The kernel release number
     *
     * @return self
     */
     ...
     * Sets sysname
     *
     * @param string $sysname The systemname/nodename
     *
     * @return self
     */
