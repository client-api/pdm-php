...
/**
 * ConfigAcmeGetConfigAcmeAccountByNameResponseDataAccountExternalAccountBinding Class Doc Comment
 *
 * @category Class
 ...
 */
class ConfigAcmeGetConfigAcmeAccountByNameResponseDataAccountExternalAccountBinding implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ConfigAcmeGetConfigAcmeAccountByNameResponse_data_account_externalAccountBinding';
     ...
     * Sets protected
     *
     * @param string $protected JOSE Header (see RFC 7515)
     *
     * @return self
     */
