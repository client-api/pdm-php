...
/**
 * PdmRemoveVanishedConfig Class Doc Comment
 *
 * @category Class
 * @package  ClientApi\Pdm
 * @author   OpenAPI Generator team
 ...
 */
class PdmRemoveVanishedConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PdmRemoveVanishedConfig';
    ...
    protected static $openAPITypes = [
        'description' => 'mixed',
        'items' => '\ClientApi\Pdm\Model\PdmAccessDomainsItemsEnum',
        'max_length' => 'mixed',
        'min_length' => 'mixed',
        'type' => 'mixed',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['max_length'] === null && !$this->isNullableSetToNull('max_length')) {
            $invalidProperties[] = "'max_length' is required";
        }
        
        if ($this->container['min_length'] === null && !$this->isNullableSetToNull('min_length')) {
            $invalidProperties[] = "'min_length' is required";
        }
     ...
     * Gets items
     *
     * @return \ClientApi\Pdm\Model\PdmAccessDomainsItemsEnum
     */
     ...
     * Sets items
     *
     * @param \ClientApi\Pdm\Model\PdmAccessDomainsItemsEnum $items remove-vanished options
     *
     * @return self
     */
