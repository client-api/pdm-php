...
/**
 * PdmPropertiesConfig Class Doc Comment
 *
 * @category Class
 * @package  ClientApi\Pdm
 * @author   OpenAPI Generator team
 ...
 */
class PdmPropertiesConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PdmPropertiesConfig';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['optional'] === null && !$this->isNullableSetToNull('optional')) {
            $invalidProperties[] = "'optional' is required";
        }
     ...
     * Sets optional
     *
     * @param mixed|null $optional optional
     *
     * @return self
     */
