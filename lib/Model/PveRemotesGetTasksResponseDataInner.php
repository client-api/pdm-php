...
/**
 * PveRemotesGetTasksResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  ClientApi\Pdm
 * @author   OpenAPI Generator team
 ...
 */
class PveRemotesGetTasksResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PveRemotesGetTasksResponse_data_inner';
     ...
     * Sets endtime
     *
     * @param int|null $endtime The task's end time.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The task's status.
     *
     * @return self
     */
