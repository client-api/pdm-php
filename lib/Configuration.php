...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://localhost:8443/api2/json';
    ...
    {
        $report  = 'PHP SDK (ClientApi\Pdm) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 9.x' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                ...
                "description" => "Proxmox Datacenter Manager API endpoint",
                "variables" => [
                    "host" => [
